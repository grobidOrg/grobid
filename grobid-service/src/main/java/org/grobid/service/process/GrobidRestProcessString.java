...
public class GrobidRestProcessString {
     ...
     *
     * @param affiliation
     * of the raw sequence of affiliation+address
    ...
    /**
     * Parse a raw reference string and return the corresponding structured reference affiliations in the requested
     * format.
     *
     * @param citation
     ...
     * @return a response object containing the structured representation of the reference
     */
    public Response processCitation(
            String citation,
    ...
    /**
     * Parse a list of raw sequence of reference strings and return the corresponding normalized bilbiographical objects
     * in the same order and in the reuqested format
     *
     * @param citation
     * list of strings of the raw sequence of reference strings
     * @param expectedResponseType
     * states which media type the caller expected (xml tei or bibtex)
     * @return a response object containing the structured representation of the references
     */
    public Response processCitationList(
    ...
    public Response processCitationPatentTXT(String text, int consolidate, boolean includeRawCitations) {
        ...
        try {
            ...
            String result = engine
                    .processAllCitationsInPatent(text, articles, patents, consolidate, includeRawCitations);
    ...
    /**
     * Parse a text corresponding to an acknowledgement and or funding section and return the extracted entities:
     * funding, person, organization, project name.
     *
     * @param text
     * string of the patent description text to be processed
     *
     * @return a response object containing the JSON representation of the acknowledgement / funding section
     */
    ...
    public String methodLogIn() {
        return ">> "
                + GrobidRestProcessString.class.getName()
                + "."
