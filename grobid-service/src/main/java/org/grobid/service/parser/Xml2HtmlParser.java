...
public class Xml2HtmlParser extends DefaultHandler {
    ...
    protected void addTag(String qName, Attributes attributes) {
        ...
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            htmlOutput.append("<font color=" + ROYAL_BLUE + ">\"").append(value);
            htmlOutput.append("\"</font>");
        }

        // End of tag
        htmlOutput.append("<font color=" + DARK_VIOLET + ">").append(GREATER_THAN);
        htmlOutput.append("</font>");
    }
    ...
    protected void endTag(String qName) {
        ...
        htmlOutput.append("<font color=" + DARK_VIOLET + ">").append(LESS_THAN + SLASH);
