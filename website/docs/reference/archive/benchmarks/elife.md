...
This is the end-to-end benchmarking result for GROBID version **0.8.2** against the `eLife` test set. See the current [Evaluation](../../../guides/training/evaluation) page for explanations and reproduction guidance.
