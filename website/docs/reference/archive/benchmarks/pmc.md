...
This is the end-to-end benchmarking result for GROBID version **0.8.2** against the `PMC_sample_1943` dataset. See the current [Evaluation](../../../guides/training/evaluation) page for explanations and reproduction guidance.
