...
public class Row extends LinePart {
    ...
    /**
     *
     * Lines, detected by the algorithm, see Line::extractLines Return rows containing cells; doesn't include empty
     * cells
     */
     ...
     * extracted rows
     * @param columnCount
     * the maximum number of columns in the table Identifies and inserts empty cells into the table based on the left
     * and right margins of the content inside columns.
     *
     */
