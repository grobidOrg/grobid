...
public class Equation {
    ...
    /*
     * public void setStartToken(LayoutToken start) { this.startToken = start; }
     *
     * public LayoutToken getStartToken() { return startToken; }
     *
     * public void setEndToken(LayoutToken end) { this.endToken = end; }
     *
    ...
    /*
     * public void setBlockPtrs(SortedSet<Integer> blockPtrs) { this.blockPtrs = blockPtrs; }
     *
     * public SortedSet<Integer> getBlockPtrs() { return blockPtrs; }
     */
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("content", content)
                .append("label", label)
                .append("id", id)
                .append("textArea", textArea)
                .append("layoutTokens", layoutTokens)
                .append("contentTokens", contentTokens)
                .append("labelTokens", labelTokens)
                .toString();
    }
}
