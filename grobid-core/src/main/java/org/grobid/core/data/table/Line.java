...
public class Line extends LinePart {
    ...
    public boolean linePartInBorders(LinePart linePart) {
        ...
        if ((this.getTop() > linePart.getBottom()) || this.getBottom() < linePart.getTop())
            return false;
    ...
    /*
     * Algorithm for extracting lines. See algorithm 1: Burcu Yildiz, Katharina Kaiser, Silvia Miksch. pdf2table: A
     * Method to Extract Table Information from PDF Files.
     */
