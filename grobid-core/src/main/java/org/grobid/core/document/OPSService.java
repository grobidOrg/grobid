...
/**
 *
 * Usage of the EPO OPS service for online interactive version of patent document retrieval. We use a POST request since
 * the EPO wsdl file result in a terrible mess with WSDL2Java.
 *
 * There is now however a new REST interface that should be used instead of the SOAP one.
 *
 * Service "fair use" implies no more than 6 request per minutes and up to 20 query per batch SOAP envelope.
 *
 */
...
public class OPSService {
     ...
     */
    public String descriptionRetrieval(String patentNumber)
