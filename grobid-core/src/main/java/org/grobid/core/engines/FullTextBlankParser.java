...
public class FullTextBlankParser extends AbstractParser {
    ...
    public Document process(File inputPdf, GrobidAnalysisConfig config) throws Exception {
    ...
    public Document process(File inputPdf, String md5Str, GrobidAnalysisConfig config) throws Exception {
        DocumentSource documentSource = DocumentSource.fromPdf(
                inputPdf,
                config.getStartPage(),
                config.getEndPage(),
     ...
     */
    public Document process(DocumentSource documentSource, GrobidAnalysisConfig config) {
        if (tmpPath == null) {
        ...
        try {
            ...
            StringBuilder tei = formatter.toTEIHeader(null, null, null, null, null, config);
