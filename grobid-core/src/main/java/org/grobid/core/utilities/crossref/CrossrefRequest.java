...
public class CrossrefRequest<T extends Object> extends Observable {
    ...
    public void execute() {
        if (params == null) {
            ...
            message.setException(
                    new Exception("Empty list of parameter, cannot build request to the consolidation service"),
                    this.toString());
        ...
        try {
            ...
            // header, as recommended by CrossRef REST API documentation, e.g.
            // &mailto=GroovyBib@example.org
            ...
            if (GrobidProperties.getCrossrefMailto() != null) {
                httpget.setHeader(
                        "User-Agent",
                        "GROBID/0.8.2 (https://github.com/kermitt2/grobid; mailto:"
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("model", model)
