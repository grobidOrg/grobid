...
public class LanguageUtilities {
    ...
    private LanguageUtilities() {
        ...
        try {
            ...
            throw new GrobidException(
                    "Class " + className + " must implement " + LanguageDetectorFactory.class.getName(), e);
    ...
    /**
     * Less basic run for language identification, where a maxumum length of text is used to identify the language. The
     * goal is to avoid wasting resources using a too long piece of text, when normally only a small chunk is enough for
     * a safe language prediction. Return a Language object consisting of the language code and a confidence score.
     *
     * @param text
     * text to classify
     * @param maxLength
