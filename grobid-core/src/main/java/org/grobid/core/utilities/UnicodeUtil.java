...
public class UnicodeUtil {
    ...
    public static String open_parenthesis = "["
            ...
            + "\\u27EC" // mathematical left white tortoise shell bracket, called bracket but totally looks like
                        // parenthesis
            + "]";
    ...
    public static String close_parenthesis = "["
            ...
            + "\\u27ED" // mathematical right white tortoise shell bracket, called bracket but totally looks like
                        // parenthesis
            + "]";
     ...
     *
     * In particular all the characters which are treated as space in C++
     * (http://en.cppreference.com/w/cpp/string/byte/isspace) will be replace by the punctuation space character U+2008
     * so that the token can be used to generate a robust feature vector legible as Wapiti input.
     *
     * @param text
     * to be normalised
    ...
    /**
     * Unicode normalisation of the token text. Works as the
     * {@link org.grobid.core.utilities.UnicodeUtil#normaliseText(java.lang.String)}, but in addition also removes
     * spaces
     * @param text
     * to be normalised
     * @return normalised string, legible for Wapiti feature generation
