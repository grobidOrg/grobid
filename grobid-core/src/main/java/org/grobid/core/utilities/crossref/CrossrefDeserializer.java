...
/**
 * Abstract deserializer to parse json response from crossref. Normalize results to a list of java objects even if only
 * one result is given. As example: WorkDeserializer.
 *
 */
