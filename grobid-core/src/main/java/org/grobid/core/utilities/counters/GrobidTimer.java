...
public class GrobidTimer {
     ...
     *
     * @param pStartNow
     * if true the timer will be started from now, else the start method will have to be called.
     */
    ...
    /**
     * Compute the time elapsed between the start of the timer and the stop time.<br>
    ...
    /**
     * Format a time from Long to String using the following format: {@link #MIN_SEC_MILI}.
     *
     * @param pTime
     * the time to format.
