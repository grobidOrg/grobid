...
public class Utilities {
     ...
     * @return true if the string value is "true", false is it equals to "false". <br>
     * If the value does not correspond to one of these 2 values, return false.
     */
    public static boolean stringToBoolean(String value) {
        boolean res = false;
        if (StringUtils.isNotBlank(value) && Boolean.toString(true).equalsIgnoreCase(value.trim())) {
            res = true;
        }
        return res;
    }
    ...
    public static Object launchMethod(Object obj, Object[] args, String methodName) throws Exception {
        ...
        if (StringUtils.isEmpty(methodName)) {
            throw new GrobidException(
                    "Missing method in command line. To specify with -exe [methodName]. " + methodName);
        }
     ...
     */
    @SuppressWarnings("rawtypes")
    public static Object launchMethod(Object obj, Object[] args, Class[] paramTypes, String methodName)
            throws Exception {
        return getMethod(obj, paramTypes, methodName).invoke(obj, args);
    }
     ...
     */
    public static List<OffsetPosition> mergePositions(
            List<OffsetPosition> positions1,
    ...
    /**
     * This version uses general LayoutToken offsets relative to the complete document. It supposes that the
     * stringPosition have been identified on the complete document string
     */
    public static List<OffsetPosition> convertStringOffsetToTokenOffsetOld(
            List<OffsetPosition> stringPosition,
    ...
    /**
     * This version uses actual LayoutToken offsets relative to the tokens present in argument only. It supposes that
     * the stringPosition have been identified on the provided tokens only, and not restricted to the complete document.
     */
