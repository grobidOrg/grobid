...
/**
 * Class for features used for reference identification in raw texts such as patent descriptions. It covers references
 * to scholar works and to patent publications.
 *
 */
