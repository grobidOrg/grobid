...
/**
 * SAX parser for XML ALTO representation of fixed layout documents. Typographical and layout information are defined at
 * token level, with line and block structures.
 *
 * This parser supports: - pdfalto output from PDF
 *
 * Expected coverage includes ALTO files generated by OCR (e.g. ABBYY) and ALTO files generated from docx files.
 *
...
public class PDFALTOSaxHandler extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (qName.equals("TextLine")) {
            ...
            /*
             * if (doc.getBlocks() != null) images.get(imagePos).setBlockNumber(doc.getBlocks().size()); else
             * images.get(imagePos).setBlockNumber(0);
             */
            /*
             * int startPos = 0; if (tokenizations.size() > 0) { startPos = tokenizations.size(); //startPos =
             * tokenizations.size()-1; } int endPos = startPos;
             */
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        ...
        if (qName.equals("Page")) {
            ...
            // Process each attribute
            /*
             * for (int i = 0; i < length; i++) { // Get names and values for each attribute String name =
             * atts.getQName(i); String value = atts.getValue(i);
             *
             * if ((name != null) && (value != null)) { if (name.equals("id")) { } else if (name.equals("x")) { } else
             * if (name.equals("y")) { } else if (name.equals("width")) { } else if (name.equals("height")) { } } }
             */
        } else if (qName.equals("String")) {
            int length = atts.getLength();
                ...
                if (subTokenizations.size() != 0) {
                    ...
                    for (String tok : subTokenizations) {
                        ...
                        if (tok.length() > 0) {
                            ...
                            /*
                             * if (block.getX() == 0.0) block.setX(currentX); if (block.getY() == 0.0)
                             * block.setY(currentY); if (block.getWidth() == 0.0) block.setWidth(currentWidth); if
                             * (block.getHeight() == 0.0) block.setHeight(currentHeight); if (block.getFontSize() ==
                             * 0.0) block.setFontSize(currentFontSize);
                             */
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (isNotBlank(name) && isNotBlank(value)) {
                    if (name.equals("ID")) {
                        ...
                        /*
                         * if (StringUtils.containsIgnoreCase(value, "bold") || StringUtils.endsWithIgnoreCase(value,
                         * "_bd")) { textStyle.setBold(true); }
                         *
                         * if (StringUtils.containsIgnoreCase(value, "italic") || StringUtils.endsWithIgnoreCase(value,
                         * "_it")) { textStyle.setItalic(true); }
                         */
                        ...
                        if (StringUtils.containsIgnoreCase(value, "italic")
                                || StringUtils.containsIgnoreCase(value, "italics")) {
                        ...
                        /*
                         * if (value.equals("serif")) { textStyle.setSerif(true); } else { textStyle.setSerif(false); }
                         */
                    }
