...
/**
 * SAX parser for ALTO XML representation of the annotations present on PDF files obtained via pdfalto. We only consider
 * here link annotations, other type of annotations (e.g. highlight) are ignored.
 *
 */
                ...
                if ((name != null) && (value != null)) {
                    if (name.equals("subtype")) {
                        ...
                        try {
                            ...
                            LOGGER.error(
                                    "The page number attribute for PDF annotation is not a valid integer: " + value);
                        }
                        if (page != -1)
