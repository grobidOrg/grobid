...
/**
 * SAX parser for ALTO XML representation of the outline/bookmark present in PDF files obtained via pdfalto.
 *
 */
public class PDFALTOOutlineSaxHandler extends DefaultHandler {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        if (qName.equals("TOCITEMS")) {
            ...
            if (bottom >= top)
                height = bottom - top;
            box = BoundingBox.fromPointAndDimensions(page, x, y, width, height);
        }
