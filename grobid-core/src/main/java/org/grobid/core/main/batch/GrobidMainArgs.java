...
public class GrobidMainArgs {
    ...
    /**
     * @param pSaveAssets
     * true if the PDF assets (bitmaps, vector graphics) should be also extracted and saved
     */
    ...
    /**
     * @return true if output a subset of the xml:id attributes must be added automatically to the resulting TEI XML
     * elements
     */
