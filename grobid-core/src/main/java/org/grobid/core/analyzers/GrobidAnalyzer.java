 ...
 *
 * The language might be preliminary set by the language recognizer or manually if it is already known by the context of
 * usage of the text.
 *
 */
    ...
    public List<String> tokenize(String text, Language lang) {
        ...
        try {
            ...
            if ((lang == null) || (lang.getLang() == null)) {
                ...
                // Korean analyser
                /*
                 * if (krAnalyzer == null) krAnalyzer = ReTokenizerFactory.create("ko_g");
                 */
