...
public class TEIFormatterTest {
    ...
    public void testMakeNotes() throws Exception {
        ...
        List<Note> footnotes = new TEIFormatter(null, null).makeNotes(tokens, text, Note.NoteType.FOOT, 37);
    ...
    public void testMarkReferencesTableTEI() throws Exception {
        ...
        List<Node> nodes = new TEIFormatter(null, null).markReferencesTableTEI(input, tokensWithOffset, tables, false);
        assertThat(nodes, hasSize(4));
        assertThat(
                ((Element) nodes.get(0)).toXML(),
