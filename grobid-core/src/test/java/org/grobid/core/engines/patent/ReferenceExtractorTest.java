...
public class ReferenceExtractorTest {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(ReferenceExtractorTest.class);
    ...
    public void extractAllReferencesStringNull() {
        ...
        String res = extractor.extractAllReferencesString(toExtracts, false, 0, false, null, null);
    ...
    public void extractAllReferencesStringArticles2() {
        ...
        if (!offsets.isEmpty() && offsets.get(0) != null) {
            ...
            while (stt.hasMoreTokens()) {
                ...
                System.err.println(token2 + "   count=" + count2 + "   charCpt=" + charCpt);
            }
            endOffset = startOffset + count2;

            System.out.println("RawBib=" + rawBib);
            System.out.println("Start=" + startOffset + "   offset=" + count2 + "   end=" + endOffset);
        }
    ...
    public void extractAllReferencesStringPatents() {
        ...
        System.out.println(
                "offset start/end/raw="
                        + patent.getOffsetBegin()
                        + "/"
                        + patent.getOffsetEnd()
                        + "/"
                        + patent.getOffsetRaw());
    ...
    public void extractAllReferencesXmlST36() {
        ...
        extractor.extractAllReferencesXMLFile(
                new File("src/test/resources/org/grobid/core/engines/patent/ReferenceExtractor/st36-sample-1.xml")
                        .getAbsolutePath(),
                false,
                0,
                false,
    ...
    public void extractAllReferencesXml() {
        ...
        List<BibDataSet> articles = new ArrayList<>();
        extractor.extractAllReferencesXMLFile(
                new File("src/test/resources/patents/006271747.xml").getAbsolutePath(),
                false,
                0,
                false,
                patents,
    ...
    public void extractAllReferencesPdf() {
        ...
        extractor.extractAllReferencesPDFFile(
                new File("src/test/resources/org/grobid/core/engines/patent/ReferenceExtractor/sample-1.pdf")
                        .getAbsolutePath(),
                false,
                0,
                false,
