...
public class TEICitationOpenEdition extends DefaultHandler {
    ...
    public void endElement(java.lang.String uri, java.lang.String localName, java.lang.String qName)
        ...
        if (qName.equals("bibl")) {
            ...
            // <bibl>CDU : <ref
            // target="http://www.hannover2007.cdu.de/download/071203-beschluss-grundsatzprogramm-4.pdf">
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        ...
        if (qName.equals("bibl")) {
            ...
            buffer.append(" ");
                ...
                || qName.equals("abbr") || qName.equals("hi") || qName.equals("nameLink") || qName.equals("settlement")
                || qName.equals("country") || qName.equals("region")) {
            // we do nothing
        } else if (qName.equals("ref")) {
            // Process each attribute
            int length = atts.getLength();
