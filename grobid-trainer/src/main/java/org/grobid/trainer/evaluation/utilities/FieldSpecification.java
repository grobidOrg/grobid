...
public class FieldSpecification {
    ...
    /**
     * This static method instantiates the fields with the appropriate paths in the different gold and extraction
     * formats.
     */
    public static void setUpFields(
        ...
        /*
         * authorField.grobidPath. add("//sourceDesc/biblStruct/analytic/author/persName/forename[@type=\"first\"]");
         * authorField.grobidPath. add("//sourceDesc/biblStruct/analytic/author/persName/forename[@type=\"middle\"]");
         */
         ...
         */
        firstAuthorField.grobidPath.add("//sourceDesc/biblStruct/analytic/author[1]/persName/surname/text()");
        // firstAuthorField.nlmPath
        // .add("/article/front/article-meta/contrib-group/contrib[@contrib-type=\"author\"]/name/given-names");
        firstAuthorField.nlmPath.add(
        ...
        affiliationField.grobidPath.add("//sourceDesc/biblStruct/analytic/author/affiliation/orgName/text()");
        affiliationField.nlmPath.add("/article/front/article-meta/contrib-group/aff/text()");
        ...
        abstractField.grobidPath.add("//profileDesc/abstract//text()");
        abstractField.nlmPath.add("/article/front/article-meta/abstract//text()");
        ...
        keywordsField.grobidPath.add("//profileDesc/textClass/keywords//text()");
        keywordsField.nlmPath.add("/article/front/article-meta/kwd-group/kwd/text()");
        ...
        /*
         * FieldSpecification sectionReferenceField = new FieldSpecification(); sectionReferenceField.fieldName =
         * "references"; sectionReferenceField.isTextual = true; sectionReferenceField.grobidPath.
         * add("//back/div/listBibl/biblStruct//text()"); sectionReferenceField.nlmPath. add("//ref-list/ref//text()");
         * fulltextFields.add(sectionReferenceField); fulltextLabels.add("references");
         */
        ...
        sectionTitleField.grobidPath.add("//text/body/div/head/text()");
        sectionTitleField.nlmPath.add("//body//sec/title/text()");
        ...
        referenceMarkerField.grobidPath.add("//ref[@type=\"bibr\"]/text()");
        referenceMarkerField.nlmPath.add("//xref[@ref-type=\"bibr\"]/text()");
        ...
        referenceFigureField.grobidPath.add("//ref[@type=\"figure\"]/text()");
        referenceFigureField.nlmPath.add("//xref[@ref-type=\"fig\"]/text()");
        ...
        referenceTableField.grobidPath.add("//ref[@type=\"table\"]/text()");
        referenceTableField.nlmPath.add("//xref[@ref-type=\"table\"]/text()");
        ...
        figureTitleField.grobidPath.add("//figure[not(@type)]/head/text()");
        figureTitleField.nlmPath.add("//fig/label/text()");
        // eLife JATS support
        figureTitleField.nlmPath.add("//fig/caption/title/text()");
        fulltextFields.add(figureTitleField);
        fulltextLabels.add("figure_title");

        /*
         * FieldSpecification figureCaptionField = new FieldSpecification(); figureCaptionField.fieldName =
         * "figure_caption"; figureCaptionField.isTextual = true; figureCaptionField.grobidPath.
         * add("//figure[not(@type)]/figDesc/text()"); figureCaptionField.nlmPath. add("//fig/caption/p/text()");
         * fulltextFields.add(figureCaptionField); fulltextLabels.add("figure_caption");
         */

        /*
         * FieldSpecification figureLabelField = new FieldSpecification(); figureLabelField.fieldName = "figure_label";
         * figureLabelField.isTextual = true; figureLabelField.grobidPath. add("//figure[not(@type)]/label/text()");
         * figureLabelField.nlmPath. add("//fig/label/text()"); fulltextFields.add(figureLabelField);
        ...
        tableTitleField.grobidPath.add("//figure[@type=\"table\"]/head/text()");
        tableTitleField.nlmPath.add("//table-wrap/label/text()");
        // eLife JATS support
        tableTitleField.nlmPath.add("//table-wrap/caption/title/text()");
        fulltextFields.add(tableTitleField);
        fulltextLabels.add("table_title");

        /*
         * FieldSpecification tableLabelField = new FieldSpecification(); tableLabelField.fieldName = "figure_label";
         * tableLabelField.isTextual = true; tableLabelField.grobidPath. add("//figure[@type=\"table\"]/label/text()");
         * tableLabelField.nlmPath. add("//fig/label/text()"); fulltextFields.add(tableLabelField);
         * fulltextLabels.add("figure_label");
         */

        /*
         * FieldSpecification tableCaptionField = new FieldSpecification(); tableCaptionField.fieldName =
         * "table_caption"; tableCaptionField.isTextual = true; tableCaptionField.grobidPath.
         * add("//figure[@type=\"table\"]/figDesc/text()"); tableCaptionField.nlmPath.
         * add("//table-wrap/caption/p/text()"); fulltextFields.add(tableCaptionField);
        ...
        dataAvailabilityFulltextField.grobidPath.add("//div[@type=\"availability\"]//text()");
        dataAvailabilityFulltextField.nlmPath.add("//sec[@sec-type=\"availability\"]//text()");
        dataAvailabilityFulltextField.nlmPath.add("//p[@content-type=\"availability\"]//text()");
        dataAvailabilityFulltextField.nlmPath.add("//sec[@specific-use=\"availability\"]//text()");
        // for eLife JATS support
        dataAvailabilityFulltextField.nlmPath.add("//sec[@sec-type=\"data-availability\"]//text()");
        // the following for PLOS JATS support
        dataAvailabilityFulltextField.nlmPath.add("//custom-meta[@id=\"data-availability\"]/meta-value//text()");
        ...
        fundingFulltextField.grobidPath.add("//div[@type=\"funding\"]//text()");
        fundingFulltextField.nlmPath.add("//sec[@sec-type=\"funding\"]//text()");
        fundingFulltextField.nlmPath.add("//p[@content-type=\"funding\"]//text()");
        fundingFulltextField.nlmPath.add("//sec[@specific-use=\"funding\"]//text()");
        // for eLife JATS support
        // the following for PLOS support
        fundingFulltextField.nlmPath.add("//funding-statement//text()");
