...
/**
 * Evaluation of the DOI matching for the extracted bibliographical references, using PDF+native publisher XML where the
 * DOI or PMID are provided. A typical example of the evaluation data is PubMed Central fulltext resources. A second
 * type of evaluation is PDF+TEI files produced via Pub2TEI fir mainstream publishers.
 *
 */
public class EvaluationDOIMatching {
    ...
    /**
     * From PDF and publisher XML (nlm or TEI), we create a dataset of raw bibliographical references extracted from the
     * PDF by GROBID associated with their DOI obtained from the XML. This set will be used for evaluating the DOI
     * matching.
     */
                        ...
                        for (BibRefAggregated goldReference : goldReferences) {
                            ...
                            // (goldReference.getDOI() != null || goldReference.getPMID() != null) ) {
                                ...
                                if ((title == null) && (author == null) && (host == null)) {
                                    ...
                                    if ((ind1 != -1) || (ind2 != -1 && ind3 != -1 && (ind4 != -1 || ind5 != -1))) {
    ...
    /**
     * Simplify a string for soft matching: lowercasing, ascii folding, remove punctuation and special characters
     */
    ...
    /**
     * This class represents a bibliographical reference by aggregating information from the publisher XML and the PDF
     * extracted information from GROBID.
     */
